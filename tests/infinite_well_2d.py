...
if __name__ == "__main__":
    ...
    plt.semilogy(n_trial, first_error_bilinear, '-o', label='Bilinéaire, $E_1$')
    plt.semilogy(n_trial, first_error_triangular, '-o', label='Triangulaire, $E_1$')
    plt.semilogy(n_trial, fifth_error_bilinear, '-o', label='Bilinéaire, $E_5$')
    plt.semilogy(n_trial, fifth_error_triangular, '-o', label='Triangulaire, $E_5$')
    plt.semilogy(n_trial, last_error_bilinear, '-o', label='Bilinéaire, $E_{20}$')
    plt.semilogy(n_trial, last_error_triangular, '-o', label='Triangulaire, $E_{20}$')

    plt.ylabel('Erreur relative (%)')
    plt.xlabel('Largeur et hauteur du puits, en nombre d''éléments')
    lgd = plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
    plt.savefig('puits_infini.pdf', bbox_extra_artists=(lgd,), bbox_inches='tight')