...
new_norm = abs(np.vdot(next_state, M.dot(next_state)))
expected_new_norm = 1 + dt**2 * abs(np.vdot(dy, M.dot(dy)))
print("Comparaison des normes : %2.5f vs %2.5f, soit %2.3f %% de trop" % (new_norm, expected_new_norm, 100*(expected_new_norm-1)))